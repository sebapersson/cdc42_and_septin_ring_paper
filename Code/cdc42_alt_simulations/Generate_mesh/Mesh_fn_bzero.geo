rad = DefineNumber[ 1.0, Name "Parameters/rad2" ];
ndens = DefineNumber[ 0.1, Name "Parameters/ndens" ];

// The parameter "dens_fine" which determines the number
// of nodes
dens_fine = 0.055; // Corresponding to 8964 nodes
//dens_fine = 0.07; // Corresponding to 4928 nodes
//dens_fine = 0.08; // Corresponding to 4928 nodes
